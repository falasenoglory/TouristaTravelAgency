...
public class TGTourFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Controllers.TourBookedList.clear();
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rv_recycler_view_tgtour);
        if (Utils.isNetworkAvailable(TGTourFragment.super.getActivity())) {

            FetchBooked tad= new FetchBooked();
            tad.execute();
...
//        }
    ...
    public class FetchBooked extends AsyncTask<Void, Void, String> {

        @Override
        protected String doInBackground(Void... params) {
            String url=Controllers.TGGetRequestUrl+ Controllers.CurrentGT.getTGGuideID()+"&status=Pending";
        ...
        protected void onPostExecute(String rt) {
            ...
            Controllers.TourBookedList.clear();
            Controllers.TourBookedList= TourBooked_API.getBookedPackages(rt);
            Log.d("Shanyl","Booked Fragment TourRequestList: "+ Controllers.TourBookedList);
            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
            mRecyclerView.setLayoutManager(layoutManager);
            mRecyclerView.setHasFixedSize(true);
            mCardAdapter = new TGTourAdapter(Controllers.TourBookedList);
    ...
    public void showToast(String msg) {
        Toast.makeText(TGTourFragment.super.getActivity(), msg, Toast.LENGTH_LONG).show();
    }
