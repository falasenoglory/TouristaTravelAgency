...
import com.touristadev.tourista.adapters.TAItineraryAdapter;
...
public class TAItineraryFragment extends Fragment {
    ...
    private ArrayList<TourPackage> tourGuideList = new ArrayList<>();
    private static String packagenameTG;
    private int position;



    public TAItineraryFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static TAItineraryFragment newInstance(String pack) {
        TAItineraryFragment fragment = new TAItineraryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCardAdapter = new TAItineraryAdapter(Controllers.PackageList,"");
