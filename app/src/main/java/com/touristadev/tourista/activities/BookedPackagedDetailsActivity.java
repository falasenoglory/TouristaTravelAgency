...
public class BookedPackagedDetailsActivity extends AppCompatActivity {
...
//                    builder.setMessage("You've just received a new Referral Code!");
//// Create TextView
//                    final TextView input = new TextView (BookedPackagedDetailsActivity.this);
//                    builder.setView(input);
//
//
//                    builder.setPositiveButton("View", new DialogInterface.OnClickListener() {
//                        public void onClick(DialogInterface dialog, int id) {
//                            Intent e = new Intent(BookedPackagedDetailsActivity.this,ReferralCodeActivity.class);
//                            e.putExtra("tourId",pack.getTourTransactionId());
//                            startActivity(e);
//
//
//                        }
...
//
//                            Intent e = new Intent(BookedPackagedDetailsActivity.this,HistoryActivity.class);
//                            startActivity(e);
//                        }
//                    });
//                    builder.show();
        ...
        btnViewItinerary.setOnClickListener(new View.OnClickListener() {
           ...
           //     ControllerFinal.RequestList.remove(position);
                Intent intent= new Intent(BookedPackagedDetailsActivity.this, BookDetailsActivity.class);
        ...
        Glide.with(BookedPackagedDetailsActivity.this).load(Controllers.TourRequestList.get(position).getPhotoPath())
                .into(imgPackage);
